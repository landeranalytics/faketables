...
A more complete example using the same Favorite Pizza Places app as [here](https://landeranalytics.github.io/faketables/articles/favorite_pizza.html) can be found [here](https://raw.githubusercontent.com/landeranalytics/faketables/main/app_db.R).
